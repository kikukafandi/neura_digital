            ...
            <div className="mx-auto max-w-6xl overflow-hidden rounded-3xl bg-[#0A2540] relative shadow-2xl">
                ...
                <div className="relative z-10 px-6 py-20 text-center md:px-20">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a href="mailto:halo@neuradigital.com" className="rounded-lg border border-white/30 bg-white/10 backdrop-blur-sm px-8 py-4 text-base font-bold text-white transition-colors hover:bg-white/20">
                            Hubungi Support
                        </a>
                    </div>
                </div>
